...
const CommissionMembersForm = ({ commissionMembers, onCommissionMembersChange }) => {
    ...
    return (
        <div>
            ...
            <div className="form-input-commission">
                <label className="form-input-text">Члены государственной экзаменационной комиссии:</label>
                <div>
...
export default CommissionMembersForm;